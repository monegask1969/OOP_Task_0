...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        array[1] = new Student(1, "Никифоров", "Инокентий", "Петрович", new GregorianCalendar(1990,10,4),"ул. Льва Толстого, 19", "+380600446458", "КИТ", 3,5);
        ...
        for (int i = 0; i < array.length; i++) {
            System.out.println("array["+i+"].getFaculty()="+array[i].getFaculty());
